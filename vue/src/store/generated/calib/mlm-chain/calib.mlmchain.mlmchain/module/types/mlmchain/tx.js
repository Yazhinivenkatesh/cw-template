...
const baseMsgBuyName = { creator: "", name: "", price: "" };
...
export class MsgClientImpl {
    ...
    BuyName(request) {
        ...
        const promise = this.rpc.request("calib.mlmchain.mlmchain.Msg", "BuyName", data);
        return promise.then((data) => MsgBuyNameResponse.decode(new Reader(data)));
    }
    SetName(request) {
        const data = MsgSetName.encode(request).finish();
        const promise = this.rpc.request("calib.mlmchain.mlmchain.Msg", "SetName", data);
