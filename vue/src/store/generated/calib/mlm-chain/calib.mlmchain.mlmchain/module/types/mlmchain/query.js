...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("calib.mlmchain.mlmchain.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Whois(request) {
        const data = QueryGetWhoisRequest.encode(request).finish();
        const promise = this.rpc.request("calib.mlmchain.mlmchain.Query", "Whois", data);
    ...
    WhoisAll(request) {
        ...
        const promise = this.rpc.request("calib.mlmchain.mlmchain.Query", "WhoisAll", data);
