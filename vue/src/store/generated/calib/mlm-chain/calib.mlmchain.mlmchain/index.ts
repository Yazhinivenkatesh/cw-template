...
import { Params } from "./module/types/mlmchain/params"
import { Whois } from "./module/types/mlmchain/whois"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: calib.mlmchain.mlmchain initialized!')
