...
const baseQueryGetUserDetailRequest = { index: "" };
...
const baseQueryGetUserDetailResponse = {};
...
const baseQueryAllUserDetailRequest = {};
...
const baseQueryAllUserDetailResponse = {};
export const QueryAllUserDetailResponse = {
    ...
    toJSON(message) {
        ...
        if (message.userDetail) {
            obj.userDetail = message.userDetail.map((e) => e ? UserDetail.toJSON(e) : undefined);
        }
        else {
            obj.userDetail = [];
        }
...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("calibchain.mlmservice.mlmservice.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    UserDetail(request) {
        const data = QueryGetUserDetailRequest.encode(request).finish();
        const promise = this.rpc.request("calibchain.mlmservice.mlmservice.Query", "UserDetail", data);
        return promise.then((data) => QueryGetUserDetailResponse.decode(new Reader(data)));
    }
    UserDetailAll(request) {
        const data = QueryAllUserDetailRequest.encode(request).finish();
        const promise = this.rpc.request("calibchain.mlmservice.mlmservice.Query", "UserDetailAll", data);
        return promise.then((data) => QueryAllUserDetailResponse.decode(new Reader(data)));
    }
}
